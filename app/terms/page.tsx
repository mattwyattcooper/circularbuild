...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-16 text-gray-900">
      <header className="space-y-3 text-center">
        <h1 className="text-3xl font-semibold text-emerald-700">
          CircularBuild Terms & Conditions
        </h1>
        <p className="text-sm text-gray-600">Last updated: August 18, 2025</p>
        <p className="mx-auto max-w-2xl text-sm text-gray-600">
          Please review the following terms carefully. They describe the legal
          responsibilities, assumption of risk, and release of liability related
          to donating or receiving construction materials through the
          CircularBuild marketplace.
        </p>
      </header>
      ...
      <footer className="rounded-2xl border border-emerald-100 bg-emerald-50 p-6 text-sm text-emerald-800">
        By continuing to use CircularBuild, you acknowledge that you have read,
        understood, and agree to these Terms & Conditions. If you do not agree,
